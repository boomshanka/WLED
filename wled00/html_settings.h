...
var timeout,d=document,laprev=55,maxB=1,maxM=4e3,maxPB=4096,maxL=1333,maxLbquot=0,customStarts=!1,startsDirty=[];function H(){window.open("https://kno.wled.ge/features/settings/#led-settings")}function B(){window.open("/settings","_self")}function gId(e){return d.getElementById(e)}function off(e){d.getElementsByName(e)[0].value=-1}function showToast(e,n=!1){var t=gId("toast");t.innerHTML=e,t.className=n?"error":"show",clearTimeout(timeout),t.style.animation="none",timeout=setTimeout((function(){t.className=t.className.replace("show","")}),2900)}function bLimits(e,n,t,i){maxB=e,maxM=t,maxPB=n,maxL=i}function isNetworkBus(e){return e>=80&&e<=95}function isRadioPwm(e){return 47==e}function pinsOK(){var e=d.getElementsByTagName("input");for(i=0;i<e.length;i++){var n=e[i].name.substring(0,2);if("L0"==n||"L1"==n||"L2"==n||"L3"==n){var t=e[i].name.substring(2),a=parseInt(d.getElementsByName("LT"+t)[0].value,10);if(isNetworkBus(a))continue;if(isRadioPwm(a)&&("L1"==n||"L2"==n))continue}if(("L0"==n||"L1"==n||"L2"==n||"L3"==n||"L4"==n||"RL"==n||"BT"==n||"IR"==n)&&""!=e[i].value&&"-1"!=e[i].value){if(d.um_p&&d.um_p.some(n=>n==parseInt(e[i].value,10)))return alert(`Sorry, pins ${JSON.stringify(d.um_p)} can't be used.`),e[i].value="",e[i].focus(),!1;if(e[i].value>5&&e[i].value<12)return alert("Sorry, pins 6-11 can not be used."),e[i].value="",e[i].focus(),!1;if("IR"!=n&&"BT"!=n&&e[i].value>33)return alert("Sorry, pins >33 are input only."),e[i].value="",e[i].focus(),!1;for(j=i+1;j<e.length;j++){var s=e[j].name.substring(0,2);if("L0"==s||"L1"==s||"L2"==s||"L3"==s||"L4"==s||"RL"==s||"BT"==s||"IR"==s){if("L"===s.substring(0,1)){var o=e[j].name.substring(2);if(isNetworkBus(parseInt(d.getElementsByName("LT"+o)[0].value,10)))continue}if(""!=e[j].value&&e[i].value==e[j].value)return alert(`Pin conflict between ${e[i].name}/${e[j].name}!`),e[j].value="",e[j].focus(),!1}}}}return!0}function trySubmit(e){if(d.Sf.data.value="",e.preventDefault(),!pinsOK())return e.stopPropagation(),!1;if(bquot>100){var n="Too many LEDs for me to handle!";maxM<1e4&&(n+="\n\rConsider using an ESP32."),alert(n)}d.Sf.checkValidity()&&d.Sf.submit()}function S(){GetV(),checkSi(),setABL()}function enABL(){var e=gId("able").checked;d.Sf.LA.value=e?laprev:0,gId("abl").style.display=e?"inline":"none",gId("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,gId("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(gId("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:gId("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:gId("LAdis").style.display="inline"}gId("m1").innerHTML=maxM,d.getElementsByName("Sf")[0].addEventListener("submit",trySubmit),UI()}function getMem(e,n,t){return e<32?maxM<1e4&&3==t?e>29?20*n:15*n:maxM>=1e4?e>29?8*n:6*n:e>29?4*n:3*n:e>31&&e<48?5:44==e||45==e?4*n:isRadioPwm(e)?4:3*n}function UI(e=!1){var n=!1,t=0;gId("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);var a=d.getElementsByTagName("select");for(i=0;i<a.length;i++)if("LT"==a[i].name.substring(0,2)){var s=a[i].name.substring(2),o=parseInt(a[i].value,10);gId("p0d"+s).innerHTML=isNetworkBus(o)?"IP address:":isRadioPwm(o)?"Signal GPIO:":o>49?"Data GPIO:":o>41?"GPIOs:":"GPIO:",gId("p1d"+s).innerHTML=o>49&&o<64?"Clk GPIO:":isRadioPwm(o)?"Range Min [ms]:":"",gId("p2d"+s).innerHTML=isRadioPwm(o)?"Range Max [ms]:":"";var l=d.getElementsByName("L1"+s)[0];for(t+=getMem(o,d.getElementsByName("LC"+s)[0].value,d.getElementsByName("L0"+s)[0].value),f=1;f<5;f++){(l=d.getElementsByName("L"+f+s)[0])&&(isNetworkBus(o)&&f<4||o>49&&1==f||o>41&&o<50&&f+40<o||isRadioPwm(o)&&f<3?(l.style.display="inline",l.required=!0):(l.style.display="none",l.required=!1,l.value=""))}e&&(gId("rf"+s).checked=gId("rf"+s).checked||31==o,o>31&&o<48&&(d.getElementsByName("LC"+s)[0].value=1)),gId("rf"+s).onclick=31==o?function(){return!1}:function(){},n|=30==o||31==o||o>40&&o<46&&43!=o,gId("co"+s).style.display=isNetworkBus(o)||41==o||42==o||isRadioPwm(o)?"none":"inline",gId("dig"+s+"c").style.display=o>40&&o<48||isRadioPwm(o)?"none":"inline",gId("dig"+s+"r").style.display=isNetworkBus(o)?"none":"inline",gId("dig"+s+"s").style.display=isNetworkBus(o)||o>40&&o<48||isRadioPwm(o)?"none":"inline",gId("dig"+s+"f").style.display=o>=16&&o<32||o>=50&&o<64?"inline":"none",gId("rev"+s).innerHTML=o>40&&o<48||isRadioPwm(o)?"Inverted output":"Reversed (rotated 180°)",gId("psd"+s).innerHTML=o>40&&o<48||isRadioPwm(o)?"Index:":"Start:"}var r=d.querySelectorAll(".wc"),u=r.length;for(i=0;i<u;i++)r[i].style.display=n?"inline":"none";var p=d.getElementsByTagName("input"),m=0,v=0,c=0;for(i=0;i<p.length;i++){var g=p[i].name.substring(0,2);s=p[i].name.substring(2);if("LC"!=g){if("L0"==g||"L1"==g)d.getElementsByName("LC"+s)[0].max=maxPB;if("L0"==g||"L1"==g||"L2"==g||"L3"==g){if(isNetworkBus(o=parseInt(d.getElementsByName("LT"+s)[0].value))){p[i].max=255,p[i].min=0,p[i].style.color="#fff";continue}if(isRadioPwm(o)&&("L1"==g||"L2"==g)){p[i].max=250,p[i].min=50,p[i].style.color="#fff";continue}p[i].max=33,p[i].min=-1}if(("L0"==g||"L1"==g||"L2"==g||"L3"==g||"L4"==g||"RL"==g||"BT"==g||"IR"==g)&&""!=p[i].value&&"-1"!=p[i].value){var f=[];if(d.um_p&&Array.isArray(d.um_p))for(k=0;k<d.um_p.length;k++)f.push(d.um_p[k]);for(j=0;j<p.length;j++)if(i!=j){var y=p[j].name.substring(0,2);if("L0"==y||"L1"==y||"L2"==y||"L3"==y||"L4"==y||"RL"==y||"BT"==y||"IR"==y){if("L"===y.substring(0,1)){var L=p[j].name.substring(2);parseInt(d.getElementsByName("LT"+L)[0].value,10);if(isNetworkBus(o))continue}""!=p[j].value&&"-1"!=p[j].value&&f.push(parseInt(p[j].value,10))}}f.some(e=>e==parseInt(p[i].value,10))?p[i].style.color="red":p[i].style.color=parseInt(p[i].value,10)>33?"orange":"#fff"}}else{var I=parseInt(p[i].value,10);customStarts&&startsDirty[s]||(gId("ls"+s).value=m),gId("ls"+s).disabled=!customStarts,I&&((a=parseInt(gId("ls"+s).value))+I>m&&(m=a+I),I>c&&(c=I),(o=parseInt(d.getElementsByName("LT"+s)[0].value))<80&&(v+=I))}}gId("lc").textContent=m,gId("pc").textContent=m==v?"":"("+v+" physical)",gId("m0").innerHTML=t,bquot=t/maxM*100,gId("dbar").style.background=`linear-gradient(90deg, ${bquot>60?bquot>90?"red":"orange":"#ccc"} 0 ${bquot}%%, #444 ${bquot}%% 100%%)`,gId("ledwarning").style.display=c>Math.min(maxPB,800)||bquot>80?"inline":"none",gId("ledwarning").style.color=c>Math.max(maxPB,800)||bquot>100?"red":"orange",gId("wreason").innerHTML=bquot>80?"80% of max. LED memory"+(bquot>100?` (<b>ERROR: Using over ${maxM}B!</b>)`:""):"800 LEDs per output";var B=Math.ceil((100+v*laprev)/500)/2;B=B>5?Math.ceil(B):B;a="";var h=30==d.Sf.LAsel.value,b=255==d.Sf.LAsel.value;B<1.02&&!h&&!b?a="ESP 5V pin with 1A USB supply":(a+=h?"12V ":b?"WS2815 12V ":"5V ",a+=B,a+="A supply connected to LEDs");var S=Math.ceil((100+v*laprev)/1500)/2,w="(for most effects, ~";w+=S=S>5?Math.ceil(S):S,w+="A is enough)<br>",gId("psu").innerHTML=a,gId("psu2").innerHTML=b?"":w,gId("json").style.display=8==d.Sf.IT.value?"":"none"}function lastEnd(e){if(e<1)return 0;v=parseInt(d.getElementsByName("LS"+(e-1))[0].value)+parseInt(d.getElementsByName("LC"+(e-1))[0].value);var n=parseInt(d.getElementsByName("LT"+(e-1))[0].value);return n>31&&n<48&&(v=1),isNaN(v)?0:v}function addLEDs(e,n=!0){var t=d.getElementsByClassName("iST"),i=t.length;if(!(1==e&&i>=maxB||-1==e&&0==i)){var a=gId("mLC");if(1==e){var s=`<div class="iST">\n<hr style="width:260px">\n${i+1}:\n<select name="LT${i}" onchange="UI(true)">\n<option value="22" selected>WS281x</option>\n<option value="30">SK6812 RGBW</option>\n<option value="31">TM1814</option>\n<option value="24">400kHz</option>\n<option value="50">WS2801</option>\n<option value="51">APA102</option>\n<option value="52">LPD8806</option>\n<option value="53">P9813</option>\n<option value="41">PWM White</option>\n<option value="42">PWM CCT</option>\n<option value="43">PWM RGB</option>\n<option value="44">PWM RGBW</option>\n<option value="45">PWM RGB+CCT</option>\n\x3c!--option value="46">PWM RGB+DCCT</option--\x3e\n<option value="47">PWM RC Signal</option>\n<option value="80">DDP RGB (network)</option>\n\x3c!--option value="81">E1.31 RGB (network)</option--\x3e\n\x3c!--option value="82">ArtNet RGB (network)</option--\x3e\n</select>&nbsp;\n<div id="co${i}" style="display:inline">Color Order:\n<select name="CO${i}">\n<option value="0">GRB</option>\n<option value="1">RGB</option>\n<option value="2">BRG</option>\n<option value="3">RBG</option>\n<option value="4">BGR</option>\n<option value="5">GBR</option>\n</select></div>\n<br>\n<span id="psd${i}">Start:</span> <input type="number" name="LS${i}" id="ls${i}" class="l starts" min="0" max="8191" value="${lastEnd(i)}" oninput="startsDirty[${i}]=true;UI();" required />&nbsp;\n<div id="dig${i}c" style="display:inline">Length: <input type="number" name="LC${i}" class="l" min="1" max="${maxPB}" value="1" required oninput="UI()" /></div>\n<br>\n<span id="p0d${i}">GPIO:</span> <input type="number" name="L0${i}" min="0" max="33" required class="xs" onchange="UI()"/>\n<span id="p1d${i}"></span><input type="number" name="L1${i}" min="0" max="33" class="xs" onchange="UI()"/>\n<span id="p2d${i}"></span><input type="number" name="L2${i}" min="0" max="33" class="xs" onchange="UI()"/>\n<span id="p3d${i}"></span><input type="number" name="L3${i}" min="0" max="33" class="xs" onchange="UI()"/>\n<span id="p4d${i}"></span><input type="number" name="L4${i}" min="0" max="33" class="xs" onchange="UI()"/>\n<div id="dig${i}r" style="display:inline"><br><span id="rev${i}">Reversed</span>: <input type="checkbox" name="CV${i}"></div>\n<div id="dig${i}s" style="display:inline"><br>Skip 1<sup>st</sup> LED: <input id="sl${i}" type="checkbox" name="SL${i}"></div>\n<div id="dig${i}f" style="display:inline"><br>Off Refresh: <input id="rf${i}" type="checkbox" name="RF${i}"></div>\n</div>`;a.insertAdjacentHTML("beforeend",s)}-1==e&&(t[--i].remove(),--i),gId("+").style.display=i<maxB-1?"inline":"none",gId("-").style.display=i>0?"inline":"none",n||UI()}}function addBtn(e,n,t){var i=gId("btns").innerHTML,a="BT"+String.fromCharCode((e<10?48:55)+e);i+=`Button ${e} GPIO: <input type="number" min="-1" max="40" name="${a}" onchange="UI()" class="xs" value="${n}">`,i+=`&nbsp;<select name="${"BE"+String.fromCharCode((e<10?48:55)+e)}">`,i+=`<option value="0" ${0==t?"selected":""}>Disabled</option>`,i+=`<option value="2" ${2==t?"selected":""}>Pushbutton</option>`,i+=`<option value="3" ${3==t?"selected":""}>Push inverted</option>`,i+=`<option value="4" ${4==t?"selected":""}>Switch</option>`,i+=`<option value="5" ${5==t?"selected":""}>PIR sensor</option>`,i+=`<option value="6" ${6==t?"selected":""}>Touch</option>`,i+=`<option value="7" ${7==t?"selected":""}>Analog</option>`,i+=`<option value="8" ${8==t?"selected":""}>Analog inverted</option>`,i+="</select>",i+=`<span style="cursor: pointer;" onclick="off('${a}')">&nbsp;&#215;</span><br>`,gId("btns").innerHTML=i}function tglSi(e){(customStarts=e)||(startsDirty=[]),UI()}function checkSi(){for(var e=!1,n=1;n<d.getElementsByClassName("iST").length;n++){parseInt(gId("ls"+(n-1)).value)+parseInt(d.getElementsByName("LC"+(n-1))[0].value)!=parseInt(gId("ls"+n).value)&&(e=!0,startsDirty[n]=!0)}0!=parseInt(gId("ls0").value)&&(e=!0,startsDirty[0]=!0),gId("si").checked=e,tglSi(e)}function uploadFile(e){var n=new XMLHttpRequest;n.addEventListener("load",(function(){showToast(this.responseText,this.status>=400)})),n.addEventListener("error",(function(e){showToast(e.stack,!0)})),n.open("POST","/upload");var t=new FormData;return t.append("data",d.Sf.data.files[0],e),n.send(t),d.Sf.data.value="",!1}function loadCfg(e){var n,t;"function"==typeof window.FileReader?(e.files?e.files[0]?(n=e.files[0],(t=new FileReader).onload=function(e){let n=e.target.result;var t=JSON.parse(n);if(t.hw){if(t.hw.led){for(var i=0;i<10;i++)addLEDs(-1);t.hw.led.ins.forEach((e,n,t)=>{addLEDs(1);for(var i=0;i<e.pin.length;i++)d.getElementsByName(`L${i}${n}`)[0].value=e.pin[i];d.getElementsByName("LT"+n)[0].value=e.type,d.getElementsByName("LS"+n)[0].value=e.start,d.getElementsByName("LC"+n)[0].value=e.len,d.getElementsByName("CO"+n)[0].value=e.order,d.getElementsByName("SL"+n)[0].checked=e.skip,d.getElementsByName("RF"+n)[0].checked=e.ref,d.getElementsByName("CV"+n)[0].checked=e.rev})}if(t.hw.btn){var a=t.hw.btn;Array.isArray(a.ins)&&(gId("btns").innerHTML=""),a.ins.forEach((e,n,t)=>{addBtn(n,e.pin[0],e.type)}),d.getElementsByName("TT")[0].value=a.tt}t.hw.ir&&(d.getElementsByName("IR")[0].value=t.hw.ir.pin,d.getElementsByName("IT")[0].value=t.hw.ir.type),t.hw.relay&&(d.getElementsByName("RL")[0].value=t.hw.relay.pin,d.getElementsByName("RM")[0].checked=t.hw.relay.inv),UI()}},t.readAsText(n)):alert("Please select a JSON file first!"):alert("This browser doesn't support the `files` property of file inputs."),e.value=""):alert("The file API isn't supported on this browser yet.")}function GetV() {var d=document;
